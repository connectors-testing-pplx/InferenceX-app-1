...
export function OverviewHistoryDetailLink({
  ...
  return (
    <a
      ...
      className="group mt-0.5 inline-flex min-h-11 items-center gap-1 rounded-sm text-2xs font-medium text-foreground underline decoration-brand/50 underline-offset-4 transition-colors hover:decoration-brand focus-visible:outline-none focus-visible:ring-[3px] focus-visible:ring-ring/50 motion-reduce:transition-none xl:min-h-8"
